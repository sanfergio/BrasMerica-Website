    ...
    <main>
        <section id="first">
            ...
            <div style="display: block; background-color: white;" id="responsePayment">
                ...
                if (!$vindiToken) {
                    echo "<p style='color:orange'>⚠️ Token VINDI não encontrado no .env</p>";
                }
                ...
                if ($_SERVER["REQUEST_METHOD"] === "POST") {
                    ...
                    if ($response === false) {
                        echo "<p>Erro na comunicação com o gateway.</p>";
                    } else {
                            ...
                            echo "
                                ...
                                '>
                                    ...
                                    <p style='margin-top: 15px; font-weight: bold; color: red; background-color: white'>
                                        Código expira em: <span style='background-color: white' id='timer'>05:00</span>
                                    </p>
                                </div>
                                ...
                                let countdown = setInterval(() => {
                                    ...
                                    if (timeLeft <= 0) {
                                        ...
                                        // Aqui você pode chamar sua função de recarregar QR Code
                                        // reloadQRCode();
                                    }
            ...
            <form id="payment-form" method="post" action="" data-yapay="payment-form">
                ...
                <button name="submit" value="Submit" type="submit">Gerar Código PIX</button>
