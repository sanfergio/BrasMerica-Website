        ...
        <div className={styles.productCard} key={product.id}>
          ...
          <div className={styles.productInfo}>
            ...
            <p className={styles.productPrice}>
              ...
              <span className={styles.discountPix}>
                {product.discountPix} 
                <SiPix style={{ color: "#32BCAD", marginLeft: "4px", verticalAlign: "middle" }} />
              </span>
            </p>
          </div>
